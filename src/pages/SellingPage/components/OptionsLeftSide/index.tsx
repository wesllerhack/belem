  ...
  return (
    <Container selected={isSelected}>
      <ul>
        ...
        <li  >
          <Link to="/painel/gerador" onClick={() => setIsSelected(2)}>< MdOutlinePlaylistAdd /><span>Cadastro de metas</span></Link>
        </li>
        <li  >
          <Link to="/painel/cadastro" onClick={() => setIsSelected(3)}><VscGraph /><span>Gerador de metas</span></Link>
        </li>
        {/* <li >
